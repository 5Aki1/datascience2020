...
Make a comment that this is Question 6, Assignment 1 before your code. Find the function in ${\tt R}$ that reports the data and the version of ${\tt R}$ that you are using. Put the code in your file.
...
Suppose I create five logical variables; the first three respresent each of my children
...
c1 <- TRUE; c2 <- FALSE; c3 <- TRUE; wife <- FALSE; me <- TRUE
```

I want to write some R code to evaluate whether we will order pizza or not.
