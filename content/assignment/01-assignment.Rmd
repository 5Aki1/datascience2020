...
Recall from the lecture that ${\tt HER2}$ is an important protein in some subtypes of breast cancer, and remember that ${\tt ERBB2}$ is the official name for ${\tt HER2}$.
