...
2. We have a <i class="fa fa-slack" aria-hidden="true"></i> <a href="https://biol480-18-concordia.slack.com"> Slack</a> workspace and you can ask questions in the #biol480 channel. You can get access to Slack by sending the TA your gmail account. Slack is great for asking questions. 
...
4. The labs  are also via Zoom. The TA will be happy to answer questions and assist you with the assignments.
...
For security reasons and for organizational simplicity for the TA, 
