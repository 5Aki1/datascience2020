...
head(sorted_tnm_tumor_brca[, c( "ajcc_pathologic_tumor_stage", "vital_status", "death_days_to")])
```
...
final_brca[1058:1068, c( "ajcc_pathologic_tumor_stage", "vital_status", "death_days_to")]
```
